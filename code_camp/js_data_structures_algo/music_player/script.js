//with get element by id '#' is not necessary
...
let userData = 
{
    //[...array1...array2], combines two arrays
    songs: [...allSongs],
    currentSong: null,
    songCurrentTime: 0
}
...
const deleteSong = (id) => {
    ...
    //filter keeps only the elements of an array that satisfy the callback function
    //keeps all the song less the song with song.id === id
